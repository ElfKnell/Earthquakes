...
class EarthquakesTests: XCTestCase {
    func testGeoJSONDecoderDecodesQuake() throws {
        ...
        XCTAssertEqual(quake.code, "021cqfy385")
        
        let expectedSeconds = TimeInterval(1633379373332) / 1000
    ...
    func testGeoJSONDecoderDecodesGeoJSON() throws {
        ...
        XCTAssertEqual(decoded.quakes.count, 5)
    ...
    func testQuakeDetailsDecoder() throws {
        let decoded = try JSONDecoder().decode(QuakeLocation.self, from: textDetail_hv72783692)
